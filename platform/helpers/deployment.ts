...
export async function deployAndInitialize(
  ...
  // 25% => 0.25 => 0.25e18
  const { platformFeeRate_e18 = 250000_000000_000000n } = deploymentArgs;
  await (await mainContract.connect(ownerSigner).setPlatformFeeRate_e18(platformFeeRate_e18)).wait();
